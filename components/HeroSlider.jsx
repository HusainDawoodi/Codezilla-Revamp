    ...
    return (
        <section className="relative min-h-screen pt-20 flex flex-col lg:grid lg:grid-cols-2 border-b-2 border-black animate-entrance-fade">
            <div className="relative h-[60vh] lg:h-auto border-b-2 lg:border-b-0 lg:border-r-2 border-black overflow-hidden bg-gray-900 group hero-slider">
                ...
                {/* SLIDE 1 */}
                <div
                    className={`absolute inset-0 hero-slide-1 transition-opacity duration-1000 ${current === 0 ? 'opacity-100 z-10' : 'opacity-0 z-0'
                        }`}
                ...
                >
                    ...
                    <div className="absolute bottom-0 left-0 p-8 lg:p-12 pl-16 z-10 text-white">
                        ...
                        <p className="font-display text-2xl lg:text-3xl font-light leading-snug max-w-md">
                            &quot;We build the systems that define the next decade of enterprise efficiency.&quot;
                        </p>
                    </div>
                </div>
                ...
                {/* SLIDE 2 */}
                <div
                    className={`absolute inset-0 hero-slide-2 transition-opacity duration-1000 ${current === 1 ? 'opacity-100 z-10' : 'opacity-0 z-0'
                        }`}
                >
                    ...
                    <div className="absolute bottom-0 left-0 p-8 lg:p-12 pl-16 z-10 text-white">
                        ...
                        <p className="font-display text-2xl lg:text-3xl font-light leading-snug max-w-md">
                            &quot;True transformation happens when human insight meets algorithmic precision.&quot;
                        </p>
                    </div>
                </div>
            ...
            <div className="relative bg-charcoal flex flex-col justify-between p-8 lg:p-16 bg-energy-gradient-dark">
                <div className="flex flex-col h-full justify-center">
                    <div className="mb-12">
                        ...
                        <p className="font-display text-2xl lg:text-3xl text-white font-light leading-tight mb-8 max-w-lg">
                        ...
                        <p className="text-xl text-gray-400 max-w-xl font-medium leading-relaxed border-l-4 border-primary pl-6">
                            We don’t just build software. We architect AI-driven systems that define the next decade of efficiency.
                        </p>
                    </div>
                    <div className="grid grid-cols-2 gap-8 pt-12 border-t-2 border-gray-800">
                        <div>
                            <span className="block text-6xl font-display font-bold text-primary mb-2">98<span className="text-3xl align-top text-white">%</span></span>
                            <span className="text-xs uppercase tracking-widest text-white font-bold">Deployment Success</span>
                        </div>
                        <div>
                            <span className="block text-6xl font-display font-bold text-primary mb-2">350<span className="text-3xl align-top text-white">+</span></span>
                            <span className="text-xs uppercase tracking-widest text-white font-bold">Active Systems</span>
                        </div>
                    </div>
                </div>
            </div>

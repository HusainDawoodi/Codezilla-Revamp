        ...
        <section className="bg-paper py-20 md:py-32 border-b border-black/5">
            <div className="max-w-7xl mx-auto px-6 md:px-12">
                <div className="mb-16 md:mb-24">
                    ...
                    <h2 className="font-display text-4xl md:text-5xl font-bold text-black uppercase tracking-tight mb-4">Strategic Capabilities Matrix</h2>
                    <p className="text-gray-600 max-w-2xl font-light text-lg md:text-xl">
                        Targeted architectural interventions designed to mitigate critical risk at every layer of your stack.
                    </p>
                </div>
                    ...
                    {CAPABILITIES_MATRIX.map((item) => (
                        <div key={item.id} className="relative group">
                            ...
                            <div className="relative z-10 space-y-8">
                                <div>
                                    <span className="text-[10px] font-bold text-red-500 uppercase tracking-widest flex items-center gap-2 mb-3">

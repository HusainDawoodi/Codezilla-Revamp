        ...
        <section className="bg-paper py-20 md:py-32 px-6 md:px-12 border-y border-black/5">
            <div className="max-w-7xl mx-auto">
                <div className="mb-16 md:mb-20">
                    <h2 className="font-display text-4xl md:text-5xl font-bold text-black uppercase tracking-tight mb-4">Ai powered quality Testing services</h2>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12">
                    {IMPACT_ROI.map((item, index) => (
                        <div key={index} className="space-y-4">
                            <h3 className="text-primary font-display text-xl md:text-xl font-extrabold uppercase tracking-tight">
                                {item.value}
                            </h3>

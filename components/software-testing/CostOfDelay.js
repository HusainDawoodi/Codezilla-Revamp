        ...
        <section className="bg-charcoal py-20 md:py-32 px-6 md:px-12">
            <div className="max-w-7xl mx-auto">
                <div className="mb-16 md:mb-24 text-center">
                    ...
                    <h2 className="font-display text-4xl md:text-6xl font-bold text-white uppercase tracking-tight mb-6">THE COST OF DELAY</h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    {COST_OF_DELAY.map((item, index) => (
                        <div key={index} className="flex flex-col">
                            {/* Phase I */}
                            <div className="relative bg-white/5 border border-white/10 p-8 md:p-10 min-h-[280px] flex flex-col justify-center overflow-hidden">
                            ...
                            {/* Phase II */}
                            <div className="relative bg-obsidian border border-primary/30 p-8 md:p-10 min-h-[280px] flex flex-col justify-center overflow-hidden group hover:border-primary transition-colors">

...
export default function ServicesGrid() {
    return (
        <section className="bg-charcoal text-white border-b-2 border-black animate-entrance-fade" style={{ animationDelay: '0.6s' }}>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 min-h-screen">
                ...
                <div className="col-span-1 md:col-span-2 lg:col-span-1 border-b-2 md:border-b-2 lg:border-b-0 lg:border-r-2 border-white/10 p-8 lg:p-12 flex flex-col justify-between bg-energy-gradient-dark relative z-10">
                    ...
                    <div className="mt-12">
                        <Link className="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest border-b border-primary pb-1 text-primary hover:text-white hover:border-white transition-colors" href="#">
                            Full Service List <span className="material-symbols-outlined text-lg">arrow_forward</span>
                        </Link>
                    </div>
                </div>

                {/* Card 1: AI & Data Strategy */}
                <div className="col-span-1 border-b-2 md:border-b-2 lg:border-b-0 border-r-2 border-white/10 p-8 lg:p-12 group hover:text-white transition-all duration-500 relative flex flex-col justify-between h-[50vh] lg:h-auto overflow-hidden">
                    <div className="absolute inset-0 z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-700">
                        <Image src="/images/aI-data-strategy.webp" alt="AI Strategy Background" fill className="object-cover" />
                    </div>
                    ...
                    <div className="flex justify-between items-start z-10">
                        <span className="font-display text-6xl font-bold text-outline-white group-hover:text-primary transition-colors">01</span>
                ...
                <div className="col-span-1 border-b-2 md:border-b-0 border-r-2 border-white/10 p-8 lg:p-12 group hover:text-white transition-all duration-500 relative flex flex-col justify-between h-[50vh] lg:h-auto overflow-hidden">
                    ...
                    <div className="flex justify-between items-start z-10">
                        <span className="font-display text-6xl font-bold text-outline-white group-hover:text-primary transition-colors">02</span>
             ...
             */}
                    ...
                    <div className="flex justify-between items-start z-10">
                        <span className="font-display text-6xl font-bold text-outline-white group-hover:text-primary transition-colors">03</span>

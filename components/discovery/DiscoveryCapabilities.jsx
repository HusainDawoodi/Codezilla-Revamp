...
export default function DiscoveryCapabilities() {
  return (
    <section className="py-32 px-8 bg-[#F3F4F6] text-black">
      <div className="max-w-7xl mx-auto">
        <div className="mb-20 animate-entrance-fade">
          <span className="text-primary font-bold tracking-widest text-sm uppercase">
            Capabilities
          </span>
          <h2 className="text-6xl md:text-7xl font-bold tracking-tighter mt-4 font-display uppercase">
            WHAT WE BRING
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {DISCOVERY_CAPABILITIES.map((item, idx) => {
            ...
            if (idx === 0 || idx === 1 || idx === 3) colSpan = "md:col-span-2";

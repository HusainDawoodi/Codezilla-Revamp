      ...
      <div className="container mx-auto px-6 md:px-12 relative z-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 space-y-6 md:space-y-8">
          ...
          <p className="text-gray-400 text-base md:text-lg max-w-xl leading-relaxed font-light border-l border-primary pl-6 md:pl-10">
            Our Mobile Engineers create, build, and optimize high-performance
            apps for iOS, Android, and cross-platform devices. In today's
            fast-paced digital environment, we create scalable, secure, and
            user-friendly mobile solutions that boost engagement.
          </p>
        ...
        <div className="lg:col-span-5 relative hidden lg:flex justify-end h-full items-end">
          <div className="relative w-full h-[600px] overflow-hidden grayscale contrast-125 mix-blend-luminosity border border-white/10 shadow-2xl rounded-sm">
            <Image
              alt="Senior Mobile Engineer"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuBemuIqAaxfCzhyJcLSpAAHFaJMb_hImgaf1Gz7ZEpXSgeLXh4OkmaODXIDa1PNdV3LWuUJ_ambLZgz5d0Aqg6K5AS5jCORD9KJnYY9NbJL1YRbNEvOvRaGSQfiYGz7INe9adLZA-Q9IB2Tx5uPGEUjvs9SnecnqE_KB1aFixVKv7GstK589YsOFi4JE5NqKGu2S-oQtBfgEEDJYFqbCSXT79MdHyzZq723dOvIIKxjme1OiQ_CClpolrax0i7_H1kxcoLrRzEf"

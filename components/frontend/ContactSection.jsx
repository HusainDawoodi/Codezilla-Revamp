  ...
  return (
    <section className="bg-charcoal py-0 min-h-[90vh] flex items-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 md:px-12 relative z-10 grid grid-cols-1 lg:grid-cols-2 items-stretch min-h-full w-full">
        <div className="py-24 pr-12 self-center space-y-16">
          <h2 className="font-display text-5xl md:text-7xl font-bold text-white uppercase tracking-tighter leading-none">
            TRANSFORM YOUR <span className="text-primary italic">FRONTEND</span>{" "}
            EXPERIENCE.
          </h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            <div className="space-y-4">
              <span className="text-primary font-mono text-[10px] uppercase tracking-[0.5em] block">
                Communication HQ
              </span>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <p className="text-gray-400 font-light">Response within 24h</p>
              </div>
            </div>
          </div>
        ...
        <div className="hidden lg:flex items-center justify-center bg-dark-accent/30 border-l border-white/5 relative">
          <div className="relative w-[500px] h-[500px] flex items-center justify-center">
            ...
            <div className="absolute inset-4 border-[2px] border-primary/20 rounded-full animate-[spin_30s_linear_infinite]"></div>
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-center z-20 w-max">

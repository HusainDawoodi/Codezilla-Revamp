    ...
    <section className="bg-[#0B0D11] py-32 overflow-hidden relative">
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center mb-32">
          ...
          <p className="text-white/70 text-base mt-6 max-w-4xl mx-auto">
            The backend development process focuses on building and managing the
            server-side logic, databases, and APIs that power applications. It
            involves handling data storage, authentication, security, and
            communication between the frontend and server to ensure smooth
            functionality, scalability, and reliability of the system.
          </p>
        </div>

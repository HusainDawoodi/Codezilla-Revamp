        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {BACKEND_SERVICES.map((service, index) => (
            ...
            >
              ...
              <p className="text-gray-100 text-md leading-relaxed font-light mb-6 border-t border-white/10 pt-8">
                <span className="text-white/70 block mb-4 font-mono text-sm tracking-widest uppercase">
                  Executive Brief:
                </span>
                {service.desc}
              </p>

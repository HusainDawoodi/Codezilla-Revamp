...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-charcoal text-white pt-20 pb-10 border-b-2 border-black animate-entrance-fade"
    ...
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-8 text-white">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              We architect the future. A rigorous, engineering-first approach to
              complex digital transformation and AI integration.
            </p>
          </div>

          {/* Services */}
          <div>
            <h4 className="text-base font-bold uppercase  tracking-widest text-primary mb-6">
              Services
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400 font-medium">
              ...
              <li className="pt-4 flex gap-4">
                <a
                  className="w-9 h-9 rounded-full border border-gray-600 flex items-center justify-center bg-white/80  hover:bg-primary hover:border-primary hover:text-black transition-colors text-xs font-bold"
                  href="#"
                >
                  <Image
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs font-bold uppercase tracking-widest text-gray-500">
          <span>&copy; {year} Codezilla Inc.</span>

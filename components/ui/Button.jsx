...
export default function Button({
    ...
    const variantStyles = {
        primary: 'bg-primary text-white hover:bg-white hover:text-black border border-primary shadow-[0_4px_12px_rgba(255,109,0,0.3)] hover:shadow-[0_4px_16px_rgba(255,109,0,0.5)]',
        secondary: 'bg-white text-black hover:bg-primary hover:text-white border-2 border-black',

...
export default function WorkCarousel() {
  ...
  const scrollToIndex = (index) => {
    ...
    const left = Math.round(
      target.offsetLeft - (scroller.clientWidth - target.offsetWidth) / 3,
    );
    ...
    >
      <div className="grid grid-cols-12 border-b-2 border-black">
        ...
        <div className="col-span-12 lg:col-span-3 border-b-2 lg:border-b-0 lg:border-r-2 border-black p-8 py-10 lg:p-12 flex flex-col justify-center bg-gray-50">
          ...
          <h2 className="font-display  !text-4xl font-bold uppercase leading-none mb-8">
        ...
        <div className="col-span-12 lg:col-span-9 relative">
          ...
          >
              ...
              <div className="absolute bottom-0 left-0 w-full bg-white border-t-2 border-black p-8 z-20">
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    />
                    <p className="font-display text-sm lg:text-1xl font-medium mt-3">
                      Maji is a UK financial wellbeing provider that makes
                      saving, spending, and planning money simpler for employees
                      and employers.
                    </p>
                  </div>
            ...
            <div className="w-[100vw] md:w-[50vw] lg:w-[37.2vw] flex-shrink-0 border-r-2 border-black h-full relative group snap-center overflow-hidden">
              ...
              <div className="relative w-full h-full">
                <Image
                  src="/images/rightcharge-main.jpg"
                  alt="Rightcharge Case Study"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-110"
                />
              </div>
              ...
              <div className="absolute bottom-0 left-0 w-full bg-white border-t-2 border-black p-8 z-20">
                <div className="flex justify-between items-end">
                  <div>
                    <Image
                      src="/images/rightcharge-logo.svg"
                      alt="Rightcharge Logo"
                      width={100}
                      height={30}
                      className="h-8 w-auto"
                    />
                    <p className="font-display text-sm lg:text-1xl font-medium mt-3">
                      An EV charging management platform that automates
                      payments, reimbursements, and reporting for fleets.
                    </p>
                  </div>
                  <span className="text-4xl font-display font-bold text-primary">
                    02
            ...
            <div className="w-[100vw] md:w-[50vw] lg:w-[37.2vw] flex-shrink-0 border-r-2 border-black h-full relative group snap-center overflow-hidden">
              ...
              <div className="relative w-full h-full">
                <Image
                  src="/images/naseni.webp"
                  alt="Naseni Case Study"
                  fill
                  className="object-cover transition-transform duration-700 group-hover:scale-110"
                />
              </div>
              ...
              <div className="absolute bottom-0 left-0 w-full bg-white border-t-2 border-black p-8 z-20">
                <div className="flex justify-between items-end">
                  <div>
                    ...
                    />
                    <p className="font-display text-sm lg:text-1xl font-medium mt-3">
                      A Nigerian government agency driving innovation through
                      engineering, manufacturing, and applied research.
                    </p>
                  </div>
                  <span className="text-4xl font-display font-bold text-primary">
                    03
